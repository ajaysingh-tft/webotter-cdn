const BASE_URL = "http://webotter.tftus.com:3002";
...
function startWebSocketConnection({apiKey, projectId}) {
  ...
  const webSocketUrl = `ws://webotter.tftus.com:3002/ws/chat/${projectId}/${uuid}/`;
  ...
  const updateConnectionStatus = (isConnected) => {
    ...
    connectionStatusElement.style.marginLeft = "7px";
    if (isConnected) {
